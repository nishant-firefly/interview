...
4. Sorting and Pagination: (sorting_pagination.py)
...
5. Highlighting: (highlighting.py)
...
These retrieval concepts form the core functionality of Elasticsearch, enabling powerful and efficient search capabilities in applications.